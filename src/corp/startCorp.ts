...
export async function main(ns : NS) : Promise<void> {
    ...
    const strategy = new AgricultureStrategy();
...
interface StartupStrategy {
    startCorporation(ns: NS, industry: string, division: string): Promise<void>;
    dump(ns: NS, industry: string, division: string): Promise<void>;
    initialUpgradeOffices(ns: NS, industry: string): Promise<void>    
}
