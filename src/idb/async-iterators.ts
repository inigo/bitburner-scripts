import { instanceOfAny, Func } from 'idb/util';
import { replaceTraps, reverseTransformCache, unwrap } from 'idb/wrap-idb-value';
import { IDBPObjectStore, IDBPIndex, IDBPCursor } from 'idb/entry';
