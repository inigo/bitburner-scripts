import { NS } from "@ns";
import { getAllServers } from "/react/utils/getAllServers";

import {domDocument, React} from "/react/libReact";
...
export const MonitorInput = ({ ns }: { ns: NS }) => {
    ...
    const onFocusHandler = () => {
        ...
        const terminalInput = domDocument.getElementById("terminal-input") as HTMLInputElement;
