...
export async function main(ns: NS): Promise<void> {
	...
	const tasks = [
		...
		{ name: "Agility", fn: (i: SleeveNo) => workout(ns, i, "agi" as GymType) },
		{ name: "Dexterity", fn: (i: SleeveNo) => workout(ns, i, "dex" as GymType) },
		{ name: "Strength", fn: (i: SleeveNo) => workout(ns, i, "str" as GymType) },
		{ name: "Defense", fn: (i: SleeveNo) => workout(ns, i, "def" as GymType) },
